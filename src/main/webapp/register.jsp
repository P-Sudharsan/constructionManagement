...
<form class="btn" action="Register" method="post">
    <table>
      ...
      <tr>
        <td><label for="Phone">Phone Number<span
            style="color: red;">*</span></label><br> <input type="text"
          id="number" name="phoneno" placeholder="Phone Number" pattern="[7-9]{1}[0-9]{9}" required> <br>
        </td>
    ...
    <br> <br> <input id="button" type="submit" value="Submit" onclick="window.location.href='Register'" disabled="true"/>
